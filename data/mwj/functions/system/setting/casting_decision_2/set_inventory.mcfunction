...
scoreboard players operation #MWL NumOfMasons = #MWL AddedRole2
scoreboard players operation #MWL NumOfDetectives = #MWL AddedRole3
scoreboard players operation #MWL NumOfThieves = #MWL AddedRole4
scoreboard players operation #MWL NumOfCats = #MWL AddedRole5