...
execute at @e[type=minecraft:armor_stand,tag=HauntPlayer_Teleporter] as @a[scores={HauntPlayer=1},distance=10..] run effect give @s minecraft:slowness 1000000 1 false
execute at @e[type=minecraft:armor_stand,tag=HauntPlayer_Teleporter] as @a[scores={HauntPlayer=1},distance=10..] run effect give @s minecraft:jump_boost 1000000 200 false
