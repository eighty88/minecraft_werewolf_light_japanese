...
execute as @s[scores={DrunkPlayer=1}] run tellraw @p[scores={CurrentRole=25,RoleOfNum=1}] [{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" は ","color":"white"},{"text":"酔っぱらっています","color":"gold","bold":true}]
