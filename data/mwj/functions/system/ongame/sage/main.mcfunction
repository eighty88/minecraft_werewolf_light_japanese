...
execute as @s[scores={DropTorch=1,RoleDone=0}] run function mwj:system/ongame/sage/detect_torch_dropped
execute as @s[scores={DropTorch=1,RoleDone=1}] run function mwj:system/ongame/roles/message_error

## Detect Page Role
execute as @s[scores={TurnPageRight=1,RoleDone=0}] run function mwj:system/ongame/sage/message_to_sage
execute as @s[scores={TurnPageLeft=1,RoleDone=0}] run function mwj:system/ongame/sage/message_to_sage
...
execute as @a[team=Player,scores={DrunkPlayer=1}] if score @s NumOfPlayers = @p[scores={CurrentRole=27,RoleOfNum=1,RoleDone=0}] TargetOfRole run function mwj:system/custom/ongame/drunk/role/sage
execute as @a[team=Player] if score @s NumOfPlayers = @p[scores={CurrentRole=27,RoleOfNum=1,RoleDone=0}] TargetOfRole run function mwj:system/ongame/sage/result
