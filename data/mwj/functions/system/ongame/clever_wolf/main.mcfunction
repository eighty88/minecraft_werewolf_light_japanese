...
execute as @s[scores={DropTorch=1,RoleDone=0}] run function mwj:system/ongame/clever_wolf/detect_torch_dropped
execute as @s[scores={DropTorch=1,RoleDone=1}] run function mwj:system/ongame/roles/message_error

## Detect Page Role
execute as @s[scores={TurnPageRight=1,RoleDone=0}] run function mwj:system/ongame/clever_wolf/message_to_clever_wolf
execute as @s[scores={TurnPageLeft=1,RoleDone=0}] run function mwj:system/ongame/clever_wolf/message_to_clever_wolf
...
execute as @a[team=Player] if score @s NumOfPlayers = @p[scores={CurrentRole=3,RoleOfNum=1,RoleDone=0}] TargetOfRole run function mwj:system/ongame/clever_wolf/result
