...
tellraw @s ["",{"text":"\n----------------------------------","color":"white"}]
tellraw @s ["",{"text":"  探偵を誰に行う？","color":"white"}]

## Send Triggers
scoreboard players add @s TargetOfRole 1
execute as @a if score @p[scores={CurrentRole=31,RoleOfNum=1}] TargetOfRole = @s NumOfPlayers unless score @p[scores={CurrentRole=31,RoleOfNum=1}] NumOfPlayers = @s NumOfPlayers run tellraw @p[scores={CurrentRole=31,RoleOfNum=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"探偵","clickEvent":{"action":"run_command","value":"/trigger RoleTrigger set 1"},"hoverEvent":{"action":"show_text","value":[{"text":"探偵"}]},"color":"green","bold":true}]
scoreboard players add @s TargetOfRole 1
execute as @a if score @p[scores={CurrentRole=31,RoleOfNum=1}] TargetOfRole = @s NumOfPlayers unless score @p[scores={CurrentRole=31,RoleOfNum=1}] NumOfPlayers = @s NumOfPlayers run tellraw @p[scores={CurrentRole=31,RoleOfNum=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"探偵","clickEvent":{"action":"run_command","value":"/trigger RoleTrigger set 2"},"hoverEvent":{"action":"show_text","value":[{"text":"探偵"}]},"color":"green","bold":true}]
scoreboard players add @s TargetOfRole 1
execute as @a if score @p[scores={CurrentRole=31,RoleOfNum=1}] TargetOfRole = @s NumOfPlayers unless score @p[scores={CurrentRole=31,RoleOfNum=1}] NumOfPlayers = @s NumOfPlayers run tellraw @p[scores={CurrentRole=31,RoleOfNum=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"探偵","clickEvent":{"action":"run_command","value":"/trigger RoleTrigger set 3"},"hoverEvent":{"action":"show_text","value":[{"text":"探偵"}]},"color":"green","bold":true}]
scoreboard players add @s TargetOfRole 1
execute as @a if score @p[scores={CurrentRole=31,RoleOfNum=1}] TargetOfRole = @s NumOfPlayers unless score @p[scores={CurrentRole=31,RoleOfNum=1}] NumOfPlayers = @s NumOfPlayers run tellraw @p[scores={CurrentRole=31,RoleOfNum=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"探偵","clickEvent":{"action":"run_command","value":"/trigger RoleTrigger set 4"},"hoverEvent":{"action":"show_text","value":[{"text":"探偵"}]},"color":"green","bold":true}]
scoreboard players add @s TargetOfRole 1
execute as @a if score @p[scores={CurrentRole=31,RoleOfNum=1}] TargetOfRole = @s NumOfPlayers unless score @p[scores={CurrentRole=31,RoleOfNum=1}] NumOfPlayers = @s NumOfPlayers run tellraw @p[scores={CurrentRole=31,RoleOfNum=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"探偵","clickEvent":{"action":"run_command","value":"/trigger RoleTrigger set 5"},"hoverEvent":{"action":"show_text","value":[{"text":"探偵"}]},"color":"green","bold":true}]
scoreboard players add @s TargetOfRole 1
execute as @a if score @p[scores={CurrentRole=31,RoleOfNum=1}] TargetOfRole = @s NumOfPlayers unless score @p[scores={CurrentRole=31,RoleOfNum=1}] NumOfPlayers = @s NumOfPlayers run tellraw @p[scores={CurrentRole=31,RoleOfNum=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"探偵","clickEvent":{"action":"run_command","value":"/trigger RoleTrigger set 6"},"hoverEvent":{"action":"show_text","value":[{"text":"探偵"}]},"color":"green","bold":true}]
scoreboard players add @s TargetOfRole 1
execute as @a if score @p[scores={CurrentRole=31,RoleOfNum=1}] TargetOfRole = @s NumOfPlayers unless score @p[scores={CurrentRole=31,RoleOfNum=1}] NumOfPlayers = @s NumOfPlayers run tellraw @p[scores={CurrentRole=31,RoleOfNum=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"探偵","clickEvent":{"action":"run_command","value":"/trigger RoleTrigger set 7"},"hoverEvent":{"action":"show_text","value":[{"text":"探偵"}]},"color":"green","bold":true}]
scoreboard players add @s TargetOfRole 1
execute as @a if score @p[scores={CurrentRole=31,RoleOfNum=1}] TargetOfRole = @s NumOfPlayers unless score @p[scores={CurrentRole=31,RoleOfNum=1}] NumOfPlayers = @s NumOfPlayers run tellraw @p[scores={CurrentRole=31,RoleOfNum=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"探偵","clickEvent":{"action":"run_command","value":"/trigger RoleTrigger set 8"},"hoverEvent":{"action":"show_text","value":[{"text":"探偵"}]},"color":"green","bold":true}]
scoreboard players add @s TargetOfRole 1
execute as @a if score @p[scores={CurrentRole=31,RoleOfNum=1}] TargetOfRole = @s NumOfPlayers unless score @p[scores={CurrentRole=31,RoleOfNum=1}] NumOfPlayers = @s NumOfPlayers run tellraw @p[scores={CurrentRole=31,RoleOfNum=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"探偵","clickEvent":{"action":"run_command","value":"/trigger RoleTrigger set 9"},"hoverEvent":{"action":"show_text","value":[{"text":"探偵"}]},"color":"green","bold":true}]
scoreboard players add @s TargetOfRole 1
execute as @a if score @p[scores={CurrentRole=31,RoleOfNum=1}] TargetOfRole = @s NumOfPlayers unless score @p[scores={CurrentRole=31,RoleOfNum=1}] NumOfPlayers = @s NumOfPlayers run tellraw @p[scores={CurrentRole=31,RoleOfNum=1}] ["",{"text":"    ","color":"white"},{"selector":"@s","color":"white"},{"text":" > ","color":"white"},{"text":"探偵","clickEvent":{"action":"run_command","value":"/trigger RoleTrigger set 10"},"hoverEvent":{"action":"show_text","value":[{"text":"探偵"}]},"color":"green","bold":true}]
